...
class DownloadFile(object):
    ...
    def perform(self):            
        try:            
            u = urllib2.urlopen(self.__url__)
            ofname = normpath("{0}{1}{2}".format(self.__loc__, sep, self.__url__.split(sep)[-1]))
            f = open(ofname, 'wb')
